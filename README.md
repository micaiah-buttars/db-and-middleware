...
app.get("/messages", messagesCtrl.getAllMessages);
app.post("/message", messagesCtrl.createMessage);
...
export default class HistoryModal extends Component {
  ...
  componentDidMount() {
    axios.get("/messages/history").then(res => {
      this.setState({
...
app.get("/messages", messagesCtrl.getAllMessages);
app.get("/messages/history", messagesCtrl.history);
app.post("/message", messagesCtrl.createMessage);
